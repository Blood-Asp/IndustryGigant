...
Recycler.addBlacklist(<ForgeMicroblock:microblock:*>);
<IC2:blockCrop>.addTooltip(format.red(format.bold("This item is DISABLED!")));
...
var logWood = [<minecraft:log:*>, <minecraft:log2:*>, <IC2:blockRubWood>] as IIngredient[];
...
PlateBender.addRecipe(tinCan, <ore:foilTin> * 2, 100, 8);
...
NEI.overrideName(<ImmersiveEngineering:storage:5>, "Block of Cupronickel");
<ImmersiveEngineering:storage:5>.displayName = "Block of Cupronickel";

NEI.overrideName(<ImmersiveEngineering:metal:5>, "Cupronickel Ingot");
<ImmersiveEngineering:metal:5>.displayName = "Cupronickel Ingot";

NEI.overrideName(<ImmersiveEngineering:metal:27>, "Cupronickel Nugget");
<ImmersiveEngineering:metal:27>.displayName = "Cupronickel Nugget";
